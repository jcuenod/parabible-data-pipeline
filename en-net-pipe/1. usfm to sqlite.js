const fs = require("fs")
const usfmToCsv = require("./custom-usfm-to-csv")
...
const usfms = fs.readdirSync("./source-files/engnet_usfm/").filter((f) => f.endsWith("usfm"))
usfms.forEach((filename) => {
	const input = `source-files/engnet_usfm/${filename}`
