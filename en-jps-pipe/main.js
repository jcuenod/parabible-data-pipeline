...
const usfms = fs
	.readdirSync("./source-files/engjps_usfm/")
	.filter((f) => f.endsWith("usfm"))
usfms.forEach((filename) => {
	const input = `source-files/engjps_usfm/${filename}`
...
const module_info = {
	...
	"description": "Translation published by the Jewish Publication Society; the first translation of the Tanakh into English by a committee of Jews.",
	"corpora": ["OT"],
	"language": "en",
